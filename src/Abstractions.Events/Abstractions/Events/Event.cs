...
namespace Abstractions.Events
{
	...
	{
		public static Schema _SCHEMA = Avro.Schema.Parse(@"{""type"":""record"",""name"":""Event"",""namespace"":""Abstractions.Events"",""fields"":[{""name"":""Name"",""doc"":""The name that uniquely identifies this event"",""type"":""string""},{""name"":""AggregateName"",""doc"":""The group/aggregate this event belongs to"",""type"":""string""},{""name"":""CreatedAt"",""doc"":""The UTC timestamp (in milliseconds) when this event was created"",""type"":""long""},{""name"":""Payload"",""doc"":""The optional payload data of this event"",""type"":[""null"",{""type"":""record"",""name"":""EventPayload"",""namespace"":""Abstractions.Events"",""fields"":[{""name"":""DataSchema"",""doc"":""The schema of the value in the 'Data' field"",""type"":""string""},{""name"":""Data"",""doc"":""The data of this payload"",""type"":""bytes""}]}]}]}");
		/// <summary>
